...
#define VDEC_IOCTL_GET_ENABLE_SEC_METADATA   _IOR(VDEC_IOCTL_MAGIC, 41, struct vdec_ioctl_msg)
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
#define VDEC_IOCTL_GET_PERF_LEVEL   _IOR(VDEC_IOCTL_MAGIC, 42, struct vdec_ioctl_msg)
enum vdec_picture {
 PICTURE_TYPE_I,
 PICTURE_TYPE_P,
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
